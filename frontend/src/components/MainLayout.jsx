/*
================================================================================
ARQUIVO: frontend/src/components/MainLayout.jsx (MODIFICADO para Formalização do Acordo)
================================================================================
*/
...
// Ícones (ADICIONADO DocumentCheckIcon)
...
const DocumentCheckIcon = () => <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>; // <-- NOVO ÍCONE AQUI
            ...
            <aside className="w-64 bg-gray-800 text-white flex flex-col flex-shrink-0">
                ...
                <nav className="flex-1 px-2 py-4 space-y-2">
                    ...
                    <NavLink to="/proposal-contract" style={({ isActive }) => isActive ? activeLinkStyle : undefined} className="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 rounded-lg">
                        <HandshakeIcon /> <span className="ml-4">Proposta e Contrato</span>
                    </NavLink>
