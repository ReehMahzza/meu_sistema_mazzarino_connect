/*
================================================================================
ARQUIVO: frontend/src/components/MainLayout.jsx (MODIFICADO para Análise de Casos)
================================================================================
*/
...
// Ícones (ADICIONADO ChartBarIcon)
...
const ChartBarIcon = () => <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2v-6a2 2 0 012-2h2a2 2 0 012 2v6a2 2 0 002 2h2a2 2 0 002-2z" /></svg>; // <-- NOVO ÍCONE AQUI
        ...
        <div className="flex h-screen bg-gray-100 font-sans">
            ...
            <aside className="w-64 bg-gray-800 text-white flex flex-col flex-shrink-0">
                ...
                <nav className="flex-1 px-2 py-4 space-y-2">
                    ...
                    {/* ADICIONADO: Novo link para Análise de Casos */}
                    <NavLink to="/case-analysis" style={({ isActive }) => isActive ? activeLinkStyle : undefined} className="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 rounded-lg">
                        <ChartBarIcon /> <span className="ml-4">Análise de Casos</span> {/* <-- NOVO LINK AQUI */}
                    </NavLink>
