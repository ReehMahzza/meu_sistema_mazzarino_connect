/*
================================================================================
ARQUIVO: frontend/src/components/MainLayout.jsx (MODIFICADO para Novo Cliente/Caso)
================================================================================
*/
...
// Ícones para o menu (ADICIONADO UserPlusIcon)
...
const UserPlusIcon = () => <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM12 14c-4.006 0-5.461-.309-7-2.5V20a2 2 0 002 2h10a2 2 0 002-2v-8.5c-1.539 2.191-2.994 2.5-7 2.5z" /></svg>;
            ...
            <main className="flex-1 flex flex-col">
                ...
                <header className="h-20 bg-white shadow-md flex items-center justify-end px-8 flex-shrink-0">
                    <div className="text-right">
                        <p className="font-semibold text-gray-800">{user?.first_name} {user?.last_name}</p> {/* Adicionado ? para segurança */}
                        <p className="text-sm text-gray-500">{user?.email}</p> {/* Adicionado ? para segurança */}
                    </div>
                </header>
