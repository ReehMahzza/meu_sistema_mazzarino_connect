/*
================================================================================
ARQUIVO: frontend/src/components/MainLayout.jsx (MODIFICADO para Buscar Contrato)
================================================================================
*/
...
const SearchIcon = () => <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>; // <-- NOVO ÍCONE AQUI
        ...
        <div className="flex h-screen bg-gray-100 font-sans">
            ...
            <aside className="w-64 bg-gray-800 text-white flex flex-col flex-shrink-0">
                ...
                <nav className="flex-1 px-2 py-4 space-y-2">
                    ...
                    {/* ADICIONADO: Link para a nova página de solicitação */}
                    <NavLink to="/request-search-service" style={({ isActive }) => isActive ? activeLinkStyle : undefined} className="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 rounded-lg">
                        <SearchIcon /> <span className="ml-4">Buscar Contrato</span> {/* <-- NOVO LINK AQUI */}
                    </NavLink>
