/*
================================================================================
ARQUIVO: frontend/src/components/MainLayout.jsx (MODIFICADO para Negociação com Banco)
================================================================================
*/
...
// Ícones (ADICIONADO BanknotesIcon)
        ...
        <div className="flex h-screen bg-gray-100 font-sans">
            ...
            <aside className="w-64 bg-gray-800 text-white flex flex-col flex-shrink-0">
                ...
                <nav className="flex-1 px-2 py-4 space-y-2">
                    ...
                    {/* ADICIONADO: Novo link para Negociação com Banco */}
                    <NavLink to="/bank-negotiation" style={({ isActive }) => isActive ? activeLinkStyle : undefined} className="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 rounded-lg">
                        <BanknotesIcon /> <span className="ml-4">Negociação com Banco</span> {/* <-- NOVO LINK AQUI */}
                    </NavLink>
