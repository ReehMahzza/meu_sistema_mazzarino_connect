"""
Django settings for mazzarino_connect project.
...
SECRET_KEY = 'django-insecure-(%-08jfjiuxwp5z6$m8*8x(2#9r#jq!!7=ok%+6hx_^uz!)2hq'
...
INSTALLED_APPS = [
    ...
    'corsheaders',  # Adicione se não tiver
    'core',
]
...
ROOT_URLCONF = 'mazzarino_connect.urls'
...
WSGI_APPLICATION = 'mazzarino_connect.wsgi.application'
